...
import { getClientAccountById, getClientIdByUserId, updateClientContactInfo } from '@/lib/client-records'
...
export async function PATCH(request: Request) {
  try {
    ...
    return NextResponse.json({ settings: { logoDataUrl, showProfile } })
  } catch (error) {
